...
from .models import Ciudad, Usuario, Producto, TipoProducto, Subcategoria,Persona,Direccion,ProductoFruta,Fruta,Venta,Pedido,Rol,Ubicacion,Permiso,Notificacion,Igv,DetallePedido,TipoProductoSubcategoria,ProductoSubcategoria,Promocion
